...
Thanks for your interest in contributing! Career-Ops is designed to work in GitHub Copilot.
...
- Keep modes language-agnostic when possible (the assistant should handle both EN and ES)
